...
st.markdown(
    ...
    <style>
      ...
      .box { border: 1px solid #E5E7EB; border-radius: 14px; padding: 16px 16px 8px 16px;
             background: #FFFFFF; box-shadow: 0 1px 2px rgba(16,24,40,.04); margin-bottom: 16px; }
      ...
      .tbl-row { display: grid; grid-template-columns: 1.3fr 1fr 1fr; padding: 8px 12px; border-radius: 10px;
                 background: #FAFAFA; margin-bottom: 6px; border: 1px dashed #E5E7EB; }
      ...
      .total-row { display: grid; grid-template-columns: 1.3fr 1fr 1fr; padding: 10px 12px; border-radius: 12px;
                   background: #EEF2FF; border: 1px solid #C7D2FE; font-weight: 700; color: #1E3A8A; margin-top: 4px; }
